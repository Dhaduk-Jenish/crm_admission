            ...
            <section class="content">
               <div class="row">
                  ...
                  <div class="form-group">
                      <label for="email">Team Generation Type:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Department Wise</option>
                                 <option value="volvo">City Wise</option>
                                 <option value="fiat">Designation Wise</option>
                            </select>
                        </div>   
                  </div>
                  <br>
                  ...
                  <div class="form-group">
                     <label for="email">Work Discription:</label>
                        <textarea class="form-control" rows="5" id="Rule" placeholder="Work Discription"></textarea>
                  </div>
