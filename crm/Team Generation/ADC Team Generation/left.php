<aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="active">
                     <a href="findex.php"><i class="fa fa-tachometer"></i><span>Notification</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
                  <li class="active">
                     <a href="findex.php"><i class="fa fa-tachometer"></i><span>Data Distribution</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
                  <li class="active">
                     <a href="findex.php"><i class="fa fa-tachometer"></i><span>Expense</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
                  <li class="active">
                     <a href="findex.php"><i class="fa fa-tachometer"></i><span>Team Generation</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
                  <li class="active">
                     <a href="findex.php"><i class="fa fa-tachometer"></i><span>Report</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
                  <li class="active">
                     <a href="findex.php"><i class="fa fa-tachometer"></i><span>Schedule Generation</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
