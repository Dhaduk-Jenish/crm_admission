               ...
               <div class="row">
                  <!-- Info message -->
                     <div class="form-group">
                      <label for="List">List Of Request:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Request 1</option>
                                 <option value="Request1">Request 2</option>
                                 <option value="Request2">Request 3</option>
                            </select>
                        </div>   
                  </div>
                  <br>
                  ...
                  <div class="form-group">
                     <label for="email">Request Defined By:</label>
                         <input type="Name" class="form-control" id="Requester Name">
                  </div>
                  <div class="form-group">
