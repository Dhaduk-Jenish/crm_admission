            ...
            <section class="content">
               <div class="row">
                  <div class="form-group">
                      <label for="email">Admission Report:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Department Wise</option>
                                 <option value="volvo">Year Wise</option>
                                 <option value="fiat">Positive</option>
                                 <option value="audi">Negative</option>
                            </select>
                        </div>   
                  </div>
                  <br>
                  <div class="form-group">
                      <label for="email">Expense Report:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Indivisual</option>
                                 <option value="volvo">Team</option>
                                 <option value="fiat">Department</option>
                            </select>
                        </div>   
                  </div>
                  <br>
                  <div class="form-group">
                      <label for="email">Team Report:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Team Report</option>
                                 <option value="volvo">Visit Team Report</option>
                            </select>
                        </div>   
                  </div>
                  <br>
                  <div class="form-group">
                      <label for="email">Status Report:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Admission Status</option>
                                 <option selected>Visit Status</option>
                  ...
                  <br>
                  <div class="form-group">
                      <label for="email">Visit Report:</label>
                       <div class="col-xs-12">
                            <select class="custom-select custom-select-lg mb-3">
                                 <option selected>Visit Expense</option>
                                 <option value="volvo">Visit Response</option>
                            </select>
                        </div>   
                  </div>
                  <br>
