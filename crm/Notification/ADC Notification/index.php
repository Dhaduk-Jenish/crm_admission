  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
   ...
   <body class="hold-transition sidebar-mini">
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" id="email" placeholder="Enter Event Subject">
    </div>
     <div class="form-group">
      <label for="email">Event Send:</label><br>

         <input type="checkbox" value="">&nbsp;Computer<br>
      
         <input type="checkbox" value="">&nbsp;Civil<br>
      
         <input type="checkbox" value="">&nbsp;Mechanical<br>
   
         <input type="checkbox" value="">&nbsp;Electrical<br>         
    </div>
     <div class="form-group">
      <label for="email">Event Rule:</label>
       <textarea class="form-control" rows="5" id="Rule" placeholder="Events Rule"></textarea>
    </div>
    <div class="form-group">
