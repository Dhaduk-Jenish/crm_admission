    	...
    	if($count_uid == 1)
    	{
    		if($count_pswd == 1)
    		{
               ...
               // }//
                //else
                //{
                  //  echo $v_uid_row['DesignId'].",".$usertype;
                   // echo "Designation Table Error";
