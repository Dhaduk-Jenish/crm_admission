         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Student Data Distribution</h1>
            ...
            <section class="content">
               <div class="row">
                ...
                <div class="form-group">
                  &nbsp;&nbsp;&nbsp;<label for="email">Select Department:</label><br>
                   <div class="col-xs-4">
                     <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check2" name="option2" value="something"> Computer Department
                     </div>
                  </div>
                  <div class="col-xs-4">
                     <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check2" name="option2" value="something"> Civil Department
                     </div>
                  </div>
                  <div class="col-xs-4">
                     <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check2" name="option2" value="something"> Mechanical Department
                     </div>
                  </div>
                  <br>
                  <div class="col-xs-4">
                     <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check2" name="option2" value="something"> Electrical Department
                     </div>
                  </div>
                  <div class="col-xs-4">
                     <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check2" name="option2" value="something"> Others Department
                     </div>
                  </div>
                  <div class="col-xs-4">
                  </div>
              ...
              <br>
               <div class="form-group">
                  <div class="col-xs-12">
                  <label for="email">Start Index:</label>
                      <input type="email" class="form-control" id="email" placeholder="Enter Start Range">
                  </div>
                  <div class="col-xs-12">
                  <label for="email">End Index:</label>
                     <input type="email" class="form-control" id="email" placeholder="Enter End Range">
               </div>
               ...
               <div class="form-group">
                  <div class="col-xs-12">
                     ...
                     <label for="pwd">Last Date :</label>
                        <input type="date" name="LastDate" placeholder="Enter Last Date">
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-xs-12">
